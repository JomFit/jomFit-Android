...
public class MovementSpeedService extends IntentService implements LocationListener, SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public static final String BROADCAST_ACTION_SPEED_CHANGED = "io.vicknesh.jomfit.SPEED_CHANGED";


    public static final String EXTENDED_DATA_CURRENT_SPEED = "io.vicknesh.jomfit.CURRENT_SPEED";
