...
package io.vicknesh.jomfit.WalkandStep.persistence;
...
public class StepCountPersistenceHelper {
    ...
    public static final String BROADCAST_ACTION_STEPS_SAVED = "io.vicknesh.jomfit.STEPS_SAVED";
    public static final String BROADCAST_ACTION_STEPS_UPDATED = "io.vicknesh.jomfit.STEPS_UPDATED";
    public static final String BROADCAST_ACTION_STEPS_INSERTED = "io.vicknesh.jomfit.STEPS_INSERTED";
