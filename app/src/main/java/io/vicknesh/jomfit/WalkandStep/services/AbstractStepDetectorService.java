...
package io.vicknesh.jomfit.WalkandStep.services;
...
import io.vicknesh.jomfit.WalkandStep.activities.TrainingActivity;
import io.vicknesh.jomfit.WalkandStep.models.StepCount;
import io.vicknesh.jomfit.WalkandStep.persistence.StepCountPersistenceHelper;
import io.vicknesh.jomfit.WalkandStep.persistence.TrainingPersistenceHelper;
import io.vicknesh.jomfit.WalkandStep.persistence.WalkingModePersistenceHelper;
import io.vicknesh.jomfit.WalkandStep.utils.StepDetectionServiceHelper;
import io.vicknesh.jomfit.WalkandStep.utils.UnitHelper;
...
public abstract class AbstractStepDetectorService extends IntentService implements SensorEventListener, SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public static final String BROADCAST_ACTION_STEPS_DETECTED = "io.vicknesh.jomfit.STEPS_DETECTED";

    public static final String EXTENDED_DATA_NEW_STEPS = "io.vicknesh.jomfit.NEW_STEPS";

    public static final String EXTENDED_DATA_TOTAL_STEPS = "io.vicknesh.jomfit.TOTAL_STEPS";
